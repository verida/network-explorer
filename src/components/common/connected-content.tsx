...
const ConnectedContent = () => {
  return (
    <>
      <div className="text-[14px] font-bold leading-[20px] text-white/60">
        Connected Wallet
      </div>
      <div className="mt-3 flex items-center gap-4 rounded-lg border border-white/15 p-6">
        <VeridaIcon />
      ...
      <div className="mt-3 flex cursor-pointer items-center gap-4 rounded-lg border border-white/15 p-6">
